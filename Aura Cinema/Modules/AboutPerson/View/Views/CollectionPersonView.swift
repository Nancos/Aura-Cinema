...
class CollectionPersonView: UIView {
    // MARK: -UI Elements -
...
private extension CollectionPersonView {
    ...
    func setupCollectionView() {
        ...
        collectionView.register(PersonCollectionCell.self, forCellWithReuseIdentifier: "PersonCollectionCell")
...
extension CollectionPersonView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "PersonCollectionCell", for: indexPath) as? PersonCollectionCell else {
