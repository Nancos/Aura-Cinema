...
class FilmographyPersonCell: UITableViewCell {
    ...
    // MARK: - Configure -
    func configurate(with filmography: [ModelPersonFilmographyCell], with movies: [MovieViewData]) {
...
private extension FilmographyPersonCell {
    ...
    func setupfilmograpyLabel() {
        filmograpyLabel.text = "Фильмография"
