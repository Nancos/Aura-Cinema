...
class MovieButtonsCell: UITableViewCell {
    // MARK: - UI Elements -
    ...
    private var saved = false {
        didSet {
            ...
            likeButton.configuration?.title = saved ? "Saved" : "Save"
        }
    }
...
private extension MovieButtonsCell {
    ...
    func setupTrailerButton() {
        setupButton(imageName: "eye", title: "Trailer", sender: trailerButton)
    ...
    func setupTrailersTableView() {
        ...
        trailersTableView.register(UITableViewCell.self, forCellReuseIdentifier: "trailerCell")
